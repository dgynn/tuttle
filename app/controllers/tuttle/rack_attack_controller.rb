  ...
  class RackAttackController < ApplicationController
    ...
    def index
      ...
      if ::Rack::Attack::VERSION < '5'
        render :plain, text: 'Tuttle Rack::Attack support requires version 5.x' and return
      end
      ...
      @rack_attack_rack_environent_settings = (rack_attack_env_vars.keys + default_keys).uniq
